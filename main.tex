...
\experience{Design Verification Engineer}
    ...
    {\begin{itemize}
        ...
        \begin{itemize}
            \item Develop compliance test cases based on a Synopsys\textsuperscript{\tiny\textregistered} Verification IP integrated environment. \href{https://www.usb.org/document-library/usb4-compliance-test-specification}{[Read more]}
            \begin{itemize}
