...
\experience{Design Verification Engineer}
    ...
    {\begin{itemize}
        ...
        \begin{itemize}
            \item Develop compliance test cases based on a Synopsys\textsuperscript{\tiny\textregistered} VIP(s) integrated environment.
            \begin{itemize}
                \item Host Interface Adapter Layer of a Host Router
            \end{itemize}
        \end{itemize}
        % \begin{itemize}
