...
\experience{Verification IP (VIP) Engineer (RDSS)\footnote{RDSS stands for Research and Development Substitute Services.}}
    ...
    {\begin{itemize}
        ...
        \begin{itemize}
            ...
            \end{itemize}
        \end{itemize}
        \item Streaming Fabric Interface (SFI) \href{https://www.intel.com/content/www/us/en/content-details/644200/streaming-fabric-interface-sfi-specification.html}{[Read more]}
        \begin{itemize}
