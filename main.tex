...
\education{National Tsing Hua University, Hsinchu, Taiwan}
    ...
    \begin{itemize}
        \item Master’s Thesis: \textit{Mapping Nearest Neighbor Compliant Quantum Circuits onto a 2-D Hexagonal Architecture} \href{https://hdl.handle.net/11296/dpttkc}{[NDLTD]}
    \end{itemize}
