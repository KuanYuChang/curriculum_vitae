...
\experience{Design Verification Engineer}
    ...
    {\begin{itemize}
        \item MIPI Improved Inter Integrated Circuit Host Controller Interface (I3C HCI\textservicemark{}) \href{https://www.mipi.org/specifications/i3c-hci}{[Read more]}
...
\education{National Tsing Hua University, Hsinchu City, Taiwan}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            \item \textbf{Master’s Thesis}: \textit{Mapping Nearest Neighbor Compliant Quantum Circuits onto a 2-D Hexagonal Architecture} \href{https://hdl.handle.net/11296/dpttkc}{[Read more]}
        \end{itemize}
